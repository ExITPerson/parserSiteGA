...
class ParserArticle:
    ...
    async def get_articles(self, url: str) -> list | None:
        ...
        blocks = soup.find_all("div", class_="I5kdwJ")
        if not blocks:
    ...
    async def _launch_browser(self, playwright):
        ...
        return await playwright.chromium.launch(
            headless=True, slow_mo=50, proxy=self._proxy
        )
    ...
    async def _navigate_to_site(self, context, url):
        ...
        try:
            ...
            await page.wait_for_selector("div.I5kdwJ", timeout=self._timeout)
        except Exception:
        ...
        attempts = 0
        while attempts < 3:
            before = await page.locator("div.I5kdwJ").count()
            await page.wait_for_timeout(1500)
            after = await page.locator("div.I5kdwJ").count()
            if before == after:
                break
            attempts += 1
